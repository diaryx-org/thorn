...
extension Tool {
    ...
    /// naming what the core needs: `add-diamond.md`, `add-arrow.md`,
    /// `add-ink.md`, `add-note.md`.
    public var isAvailable: Bool {
        switch self {
        case .hand, .select, .rect, .ellipse, .line, .text, .eraser: true
        case .diamond, .arrow, .draw, .note: false
        }
    }
