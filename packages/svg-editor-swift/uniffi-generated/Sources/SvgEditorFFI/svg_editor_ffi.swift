...
#if canImport(svg_editor_ffiFFI)
import svg_editor_ffiFFI
#endif
...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_svg_editor_ffi_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_svg_editor_ffi_rustbuffer_free(self, $0) }
    }
}
...
open class Drawing:
    ...
    public func uniffiClonePointer() -> UnsafeMutableRawPointer {
        return try! rustCall { uniffi_svg_editor_ffi_fn_clone_drawing(self.pointer, $0) }
    }
    ...
    deinit {
        ...
        try! rustCall { uniffi_svg_editor_ffi_fn_free_drawing(pointer, $0) }
    }
...
public static func `open`(source: String)throws  -> Drawing {
    ...
    uniffi_svg_editor_ffi_fn_constructor_drawing_open(
...
open func bounds(id: String) -> Bounds? {
    ...
    uniffi_svg_editor_ffi_fn_method_drawing_bounds(self.uniffiClonePointer(),
...
open func check() -> [Finding] {
    ...
    uniffi_svg_editor_ffi_fn_method_drawing_check(self.uniffiClonePointer(),$0
    )
})
}
...
open func delete(id: String)throws  {try rustCallWithError(FfiConverterTypeDrawingError.lift) {
    uniffi_svg_editor_ffi_fn_method_drawing_delete(self.uniffiClonePointer(),
        FfiConverterString.lower(id),$0
    )
}
}
...
open func moveBy(id: String, dx: Double, dy: Double)throws  {try rustCallWithError(FfiConverterTypeDrawingError.lift) {
    uniffi_svg_editor_ffi_fn_method_drawing_move_by(self.uniffiClonePointer(),
...
open func redo()throws  -> Bool {
    ...
    uniffi_svg_editor_ffi_fn_method_drawing_redo(self.uniffiClonePointer(),$0
    )
})
}
...
open func reorder(id: String, order: Order)throws  -> Bool {
    return try  FfiConverterBool.lift(try rustCallWithError(FfiConverterTypeDrawingError.lift) {
    uniffi_svg_editor_ffi_fn_method_drawing_reorder(self.uniffiClonePointer(),
        FfiConverterString.lower(id),
...
open func resize(id: String, to: Bounds)throws  {try rustCallWithError(FfiConverterTypeDrawingError.lift) {
    uniffi_svg_editor_ffi_fn_method_drawing_resize(self.uniffiClonePointer(),
        FfiConverterString.lower(id),
...
open func shapes() -> [Shape] {
    ...
    uniffi_svg_editor_ffi_fn_method_drawing_shapes(self.uniffiClonePointer(),$0
    )
})
}
...
open func source() -> String {
    ...
    uniffi_svg_editor_ffi_fn_method_drawing_source(self.uniffiClonePointer(),$0
    )
})
}
...
open func undo()throws  -> Bool {
    return try  FfiConverterBool.lift(try rustCallWithError(FfiConverterTypeDrawingError.lift) {
    uniffi_svg_editor_ffi_fn_method_drawing_undo(self.uniffiClonePointer(),$0
    )
})
}
...
private var initializationResult: InitializationResult = {
    ...
    let scaffolding_contract_version = ffi_svg_editor_ffi_uniffi_contract_version()
    ...
    if (uniffi_svg_editor_ffi_checksum_method_drawing_check() != 31079) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_svg_editor_ffi_checksum_method_drawing_redo() != 46984) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_svg_editor_ffi_checksum_method_drawing_reorder() != 46752) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_svg_editor_ffi_checksum_method_drawing_resize() != 38008) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_svg_editor_ffi_checksum_method_drawing_shapes() != 56928) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_svg_editor_ffi_checksum_method_drawing_source() != 60947) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_svg_editor_ffi_checksum_method_drawing_undo() != 44109) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_svg_editor_ffi_checksum_constructor_drawing_open() != 51427) {
        return InitializationResult.apiChecksumMismatch
    }
